...
def activity(bot: Bot):
    ...
    get_user_agent()
    bot.onchain.change_chain(Chains.CHAINBASE_TESTNET)
    ...
    for _ in range(60):
        ...
        if balance_after < balance_before:
            ...
            logger.success(f'Transfer токенов произведён успешно! Данные записаны в таблицу ChainbaseActivity.xlsx. Hash: {tx_hash}')
            break
        random_sleep(5, 10)
    else:
